...
void internal_msgQueueRead() {
    ...
    // se la coda è vuota metto il processo running in waiting descriptors
    if (!msgSubqueue) {
    ...
    // prende il primo messaggio della lista di messaggi d
    ...
    // rimuovo messaggio dalla lista di messaggi della sottocoda e decremento la size
