...
void internal_msgQueueWrite() {
    ...
    if (msg_len > MAX_TEXT_LEN) {       // MSG TROPPO GRANDE
    ...
    printf("||> Allocating a new msg in the subqueue with priority %u\n", priority);
    ...
    // inserisco (scrivo) il messaggio nella lista dei msg della sottocoda con quella priority
